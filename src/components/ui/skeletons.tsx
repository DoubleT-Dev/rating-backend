...
export function BizTableSkeleton() {
  return (
    <div className="mt-6 flow-root">
      <div className="inline-block min-w-full align-middle">
        <div className="rounded-lg bg-gray-50 p-2 md:pt-0">
...
export function RatingCategoriesTableSkeleton() {
  return (
    <div className="mt-6 flow-root">
      <div className="inline-block min-w-full align-middle">
        <div className="rounded-lg bg-gray-50 p-2 md:pt-0">
          <div className="md:hidden">
            <RatingCategoriesMobileSkeleton />
            <RatingCategoriesMobileSkeleton />
            <RatingCategoriesMobileSkeleton />
          </div>
          <table className="hidden min-w-full text-gray-900 md:table">
            ...
            <tbody className="bg-white">
              <RatingCategoriesTableRowSkeleton />
              <RatingCategoriesTableRowSkeleton />
              <RatingCategoriesTableRowSkeleton />
            </tbody>
          </table>
...
export function BizAddressesTableSkeleton() {
  return (
    <div className="mt-6 flow-root">
      <div className="inline-block min-w-full align-middle">
        <div className="rounded-lg bg-gray-50 p-2 md:pt-0">
          <div className="md:hidden">
            <BizAddressesMobileSkeleton />
            <BizAddressesMobileSkeleton />
            <BizAddressesMobileSkeleton />
            <BizAddressesMobileSkeleton />
            <BizAddressesMobileSkeleton />
